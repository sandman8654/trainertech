...
<?php echo alert(); ?>   
<h4>Add System Exercise</h4>
<?php echo form_open_multipart(current_url(), array('class'=>'tasi-form')); ?>
<div class="form-group">
  <label for="exampleInputEmail1">Name *</label> 
  <input type="text" class="form-control" name="name" id="" value="<?php echo set_value('name'); ?>">
  <span class="error"><?php echo form_error('name'); ?></span>
</div>

<div class="form-group">
  <label for="exampleInputEmail1">Image *</label> 
  <input type="file" name="exercise_image"> <br>
  <?php if ($galleryimages): ?>
    <a href="javascript:void(0)" class="showgallery_w">or Select Image From Library <input type="hidden" value="" name="ex_img" id="ex_img"> </a>              
