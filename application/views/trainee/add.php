...
<div class="form-group">
    ...
    <select class="form-control" name="trainer_id">
      ...
      <?php foreach($trainer as $row){ ?>
        <option value="<?php echo $row->id ?>"  <?php echo set_select('trainer_id', $row->id); ?> ><?php echo $row->fname." ".$row->lname ?></option>
      <?php } ?>
    </select>
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" name="confirm_password" id="exampleInputConfim" placeholder="Confirm Password">
