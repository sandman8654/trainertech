            ...
            <table class="table table-striped home-table">
              ...
              <tbody>
                <?php if ($workout_notes): foreach ($workout_notes as $row) { ?>
                  ...
                  <td>
                         <a onclick="return confirm('Are you sure?')" href="<?php echo base_url() ?>workout/delete_notes/<?php echo $row->id ?>/<?php echo $workout->id ?>"><i class="glyphicon glyphicon-remove"></i></a>
                  </td>
