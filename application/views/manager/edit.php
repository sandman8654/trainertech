...
<section class="contant">
  ...
  <?php echo form_open_multipart(cms_current_url(), array('class'=>'tasi-form')); ?>
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="fname" id="" value="<?php echo $manager->fname;?>" placeholder="First Name">
      <span class="error"><?php echo form_error('fname'); ?></span>
    </div>   
      <div class="form-group">
      <label for="exampleInputEmail1">Last Name</label> 
      <input type="text" class="form-control" name="lname" id="" value="<?php echo $manager->lname; ?>" placeholder="Last Name">
      <span class="error"><?php echo form_error('lname'); ?></span>
    </div>                
  <div class="form-group">
      <label for="exampleInputEmail1">Email Address</label> 
      <input type="text" class="form-control" name="email" id="" value="<?php echo $manager->email; ?>" placeholder="Email">
     ...
     <div class="form-group">
      ...
      rows="" name="address" id="" value="<?php echo $manager->address; ?>" placeholder="Address">
      <span class="error"><?php echo form_error('address'); ?></span>
    </div><!-- </textarea> -->
       <div class="form-group">
      <label for="exampleInputEmail1">City</label> 
      <input type="text" class="form-control" name="city" id="" value="<?php echo $manager->city; ?>" placeholder="City">
