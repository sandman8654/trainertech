...
<!-- /TinyMCE -->
  ...
  <?php echo form_open_multipart(cms_current_url(), array('class'=>'tasi-form')); ?>
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" name="confirm_password" value="<?php echo set_value('confirm_password'); ?>" id="exampleInputConfim" placeholder="Confirm Password">
