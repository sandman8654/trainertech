...
<div class="form-group exercise_div">		
	...
	<br>
	<input type="text" class="form-control exer_name" name="exercise[]" id="" value="<?php echo $exercise->name ?>">
	<input type="hidden" name="default_exercise_id[]" id="" value="<?php echo $exercise->id ?>">
	<span class="error exer_name_error"></span>
	<br>
	<label for="">Description</label>
	<br>
	<textarea class="form-control" name="description[]" rows="5"><?php echo $exercise->description ?></textarea>
	<br>
	...
	<?php if ($galleryimages): ?>
        <a href="javascript:void(0)" class="showgallery_e">
			...
			<input type="hidden" value="<?php echo $exercise->image ?>" name="exerciseimg[]" class="exerciseimg">
        </a>              
