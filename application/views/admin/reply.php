<section class="contant">
  <?php echo alert(); ?>   
            ...
            <div class="row">              
              <div class="col-sm-11 col-md-10 main">                                          
                  ...
                  <?php if ($conversation): foreach($conversation as $row): ?>
                      <div class="col-sm-12">                
                        <br>
                        <h4><?php if($row->send_by == '1') echo "Admin"; elseif($row->send_by == '2') echo $row->fname; ?> 
    ...
    <script type="text/javascript">
      $('#statusss').change(function(event){
        var val = $(this).val();
        if(val != "" && confirm('Are you sure')){
          window.location.href='<?php echo base_url() ?>admin/status/<?php echo $support->token2; ?>/'+val;
        }else{
          $(this).val();
        }
