...
// AWS access info
if (!defined('awsAccessKey')) define('awsAccessKey', 'AKIAIA22PI772AVJUT4Q');
if (!defined('awsSecretKey')) define('awsSecretKey', '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');

$uploadFile = dirname(__FILE__).'/'.$_GET['file'].'.txt'; // File to upload, we'll use the S3 class since it exists
$bucketName = strtolower('et123987'); // Temporary bucket
